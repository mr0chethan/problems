...
public class permutations_combinations{
    ...
    public static int singleSupplyTargetSumPermutationsSubsequence(int[] arr, int target, int index , String permutationsSoFar, boolean[] used){
        ...
        int count=0;
        if( !used[ index ] && target - arr[ index ] >= 0){
            used[ index ] =true;
    ...
    public static int spaceElementCombinations(int totalNoOfSpaces, int spaceIndexNextAvailable, int totalNoOfElements, int elementIndexToBePlacedNext, String spaceElementCombinationsSoFar){
        if( elementIndexToBePlacedNext == totalNoOfElements){
        ...
        for( int spaceIndex = spaceIndexNextAvailable; spaceIndex < totalNoOfSpaces; spaceIndex++){
            noOfspaceElementCombinations += spaceElementCombinations( totalNoOfSpaces, spaceIndex + 1, totalNoOfElements, elementIndexToBePlacedNext + 1, spaceElementCombinationsSoFar + "s" + spaceIndex + "-e" + elementIndexToBePlacedNext +", ");
        }
        return noOfspaceElementCombinations;
    }

    public static int spaceElementPermutations( boolean[]spaceUsed, int totalNoOfElements, int elementIndexToBePlacedNext, String spaceElementPermutationsSoFar){
        if( elementIndexToBePlacedNext == totalNoOfElements){
        ...
        for( int spaceIndex = 0; spaceIndex < spaceUsed.length; spaceIndex++){
            if( !spaceUsed[ spaceIndex ] ){
                ...
                noOfSpaceElementPermutations += spaceElementPermutations( spaceUsed, totalNoOfElements, elementIndexToBePlacedNext + 1, spaceElementPermutationsSoFar + "s" + spaceIndex + "-e" + elementIndexToBePlacedNext +", ");
    ...
    public static int spaceElementCombinationsSubsequence(){
    ...
    public static void main( String[] args ){
        ...
        // singleSupplyTargetSumPermutationsSubsequence( arr, 8, 0, "", new boolean[ arr.length ]);
