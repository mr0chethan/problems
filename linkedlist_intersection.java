...
public class linkedlist_intersection {
  ...
  public static class LinkedList {
    ...
    //     this.tail=this.head;
    //     Node reverseHeadNext=this.head,reverseHead=this.head.next,nextHead=this.head.next.next;
    ...
    public static int findIntersection(LinkedList one, LinkedList two){
      // write your code here
    //   if(one.head==null||two.head==null)return 0;
    //   one.reversePI();
    //   two.reversePI();
      Node curOne=one.head;
      Node curTwo=two.head;
      if(curOne!=null && curTwo!=null && curOne.next==curTwo.next){
          while(curOne!=null && curTwo!=null && curOne.next==curTwo.next){
              System.out.println("line1: curOne.data: "+curOne.data+" curTwo.data: "+curTwo.data);
          curOne=curOne.next;
          curTwo=curTwo.next;
        }
        if(curOne!=null){
            return curOne.next.data;
        }
        else{
            return 0;
        }
